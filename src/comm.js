...
export async function openExternal(url) {
  return universalElectronCallback("openExternal", url);
}
export async function backgroundThrottle(id, shouldThrottle) {
  return universalElectronCallback("backgroundThrottle", id, shouldThrottle);
}
